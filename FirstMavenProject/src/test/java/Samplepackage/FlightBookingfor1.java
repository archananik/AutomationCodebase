...
public class FlightBookingfor1 {
	...
	public void login(String username,String password)
	{
		...
		selectOption(dr, "//select[@name='passCount']", "1");
		selectOption(dr, "//select[@name='fromPort']", "London");
		selectOption(dr, "//select[@name='fromMonth']", "May");
		selectOption(dr, "//select[@name='fromDay']", "28");
		selectOption(dr, "//select[@name='toPort']", "New York");
		selectOption(dr, "//select[@name='toMonth']", "March");
		selectOption(dr, "//select[@name='toDay']", "28");
		dr.findElement(By.xpath("//input[@value='Business']")).click();
		selectOption(dr, "//select[@name='airline']", "Blue Skies Airlines");
		...
		selectOption(dr, "//select[@name='pass.0.meal']", "Diabetic");
		// creditcard details
		selectOption(dr, "//select[@name='creditCard']", "MasterCard");
		dr.findElement(By.name("creditnumber")).sendKeys("987-654-322-345");
		selectOption(dr, "//select[@name='cc_exp_dt_mn']", "02");
		selectOption(dr, "//select[@name='cc_exp_dt_yr']", "2009");
		...
		dr.findElement(By.cssSelector("input[value='checkbox']")).click();
		// billing address
		...
		selectOption(dr, "//select[@name='billCountry']", "UNITED STATES");
		...
		selectOption(dr, "//select[@name='delCountry']", "UNITED STATES");
	...
	public static void selectOption(ChromeDriver dr, String xpath, String option) {
		WebElement ele1 = dr.findElement(By.xpath(xpath));
