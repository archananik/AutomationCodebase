...
public class FlightBookingfor2 {
	...
	public void login(String username,String password)
	{
		...
		FlightBookingfor1.selectOption(dr, "//select[@name='passCount']", "2");
		FlightBookingfor1.selectOption(dr, "//select[@name='fromPort']", "London");
		FlightBookingfor1.selectOption(dr, "//select[@name='fromMonth']", "June");
		FlightBookingfor1.selectOption(dr, "//select[@name='fromDay']", "30");
		FlightBookingfor1.selectOption(dr, "//select[@name='toPort']", "New York");
		FlightBookingfor1.selectOption(dr, "//select[@name='toMonth']", "March");
		FlightBookingfor1.selectOption(dr, "//select[@name='toDay']", "1");
		...
		dr.findElement(By.name("passFirst0")).sendKeys("Archana");
		dr.findElement(By.name("passLast0")).sendKeys("Nikam");

		FlightBookingfor1.selectOption(dr, "//select[@name='pass.0.meal']", "Diabetic");
		dr.findElement(By.name("passFirst1")).sendKeys("Yogesh");
		dr.findElement(By.name("passLast1")).sendKeys("Nikam");

		FlightBookingfor1.selectOption(dr, "//select[@name='pass.1.meal']", "Diabetic");
		...
		dr.findElement(By.name("cc_frst_name")).sendKeys("Archana");
		dr.findElement(By.name("cc_mid_name")).sendKeys("Yogesh");
		dr.findElement(By.name("cc_last_name")).sendKeys("Nikam");
