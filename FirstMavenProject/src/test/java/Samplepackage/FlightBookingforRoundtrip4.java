...
public class FlightBookingforRoundtrip4 {
	...
	public void login(String username,String password)
	{
		...
		FlightBookingfor1.selectOption(dr, "//select[@name='passCount']","4");
        ...
        dr.findElement(By.name("passFirst1")).sendKeys("sahil");
		dr.findElement(By.name("passLast1")).sendKeys("Gupta");
		FlightBookingfor1.selectOption(dr, "//select[@name='pass.1.meal']", "Low Calorie");
        
        dr.findElement(By.name("passFirst2")).sendKeys("Sujay");
		dr.findElement(By.name("passLast2")).sendKeys("Gupta");
		FlightBookingfor1.selectOption(dr, "//select[@name='pass.2.meal']", "Vegetarian");
        
        dr.findElement(By.name("passFirst3")).sendKeys("Jay");
		dr.findElement(By.name("passLast3")).sendKeys("Gupta");
		FlightBookingfor1.selectOption(dr, "//select[@name='pass.3.meal']", "Diabetic");
		// creditcard details
		...
		if (list.size() >= 1) {
			System.out.println("Flight is booked for roundtrip for 4");
		} else {
	...
	public String[][] getData() throws IOException
	{
		...
		int rows=xl.getrowcount("Sheet4");
		int cols=xl.getColumncount("Sheet4");
		...
		for(int r=2;r<=rows;r++)
		{
			...
			{
				data[r-2][c-1]=xl.getCellData("Sheet4", r, c);
			}
		}
